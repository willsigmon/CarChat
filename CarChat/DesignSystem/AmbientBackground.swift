            ...
            ZStack {
                ...
                Circle()
                    .fill(
                        RadialGradient(
                            colors: [
                                CarChatTheme.Colors.accentGradientEnd.opacity(orbIntensity * 0.7),
                                CarChatTheme.Colors.accentGradientEnd.opacity(0)
                            ],
                            center: .center,
                            startRadius: 0,
...
struct FloatingParticles: View {
    ...
    init(count: Int = 15, isActive: Bool = true, color: Color = CarChatTheme.Colors.accentGradientStart) {
        self.count = count
